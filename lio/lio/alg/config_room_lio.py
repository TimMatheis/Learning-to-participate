...
def get_config():
    ...
    config.lio.entropy_coeff = 0.05 # 0.01
    config.lio.epsilon_div = 250 # 1000
    config.lio.epsilon_end = 0.01 # 0.1
    config.lio.epsilon_start = 0.5 # 0.5
    ...
    config.lio.tau = 0.01
    config.lio.use_actor_critic = False # False
