...
class Env(object):
    ...
    def reset(self):
        ...
        return self.process_obs(obs) # , share_0 # , share_0 # ---------------------- added: , share_0

    def step(self, actions):    #--- added:, share_0 --------------------------------------------
        """Takes a step in env.
    ...
    def trade_step(self, actions):    
        ...
        share_0 = max(actions)/5

        return obs_next, share_0
    # -------------------------------------------------------------------------------------------
