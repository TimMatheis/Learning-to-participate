...
def get_config():
    ...
    config.alg.n_episodes = 100000 # 100000
    config.alg.n_eval = 10 # 10
    config.alg.n_test = 2
    config.alg.period = 1000 # 1000

    config.env = ConfigDict()
    config.env.name = 'ipd'
    config.env.max_steps = 5 # 5
    ...
    config.lio.epsilon_div = 500 # 5000
    ...
    config.main.seed = 1 # 12341 # 5601, 2001, 1000, 1, 12341
